...
public class Client {
    ...
    public static Client initiate(String host, int port, ClientInterface c, Consumer<String> r) {
    ...
    public Object[] setUsername(ClientInterface c) { // 0 = error, 1, if there, = username
        String name, res = "";
        Error e;
        boolean ok = false;
        do {
